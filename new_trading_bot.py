...
# ✅ Load API Credentials (Priority: Streamlit Secrets)
...
# ✅ Create Bybit session with Proxy and disable SSL verification
session = HTTP(
    testnet=TEST_MODE,
    api_key=api_key,
...
session._session.verify = False  # Disable SSL certificate verification
